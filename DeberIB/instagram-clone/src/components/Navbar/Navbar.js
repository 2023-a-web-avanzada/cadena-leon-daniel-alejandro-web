...
import big_logo from "../../res/Instagram_logo.svg.png";
import small_logo from "../../res/87390.png";
import message_icon from "../../res/icons8-facebook-messenger-256.png"
import test_pp_icon from "../../res/red_pp.png"
import navbar_icon from "../../res/navigation-bar-icon-20.jpg"
    ...
    return (
        <div>
            ...
            <div className="nav-items">
                ...
                <Link to="/direct/inbox/"><div id="message"><div className="red-badge" style={{ zIndex: "10" }}>1</div><img src={message_icon} alt="logo" />Messages</div></Link>
                <Link to="/">
